<template>
  <div class="css_lab">
    <slot />
    <a id="continue" class="scroll" href="#home_text"
      ><span></span>
      Continuez pour réserver
    </a>
    <div class="sky">
      <div></div>
      <div></div>
...
.sky:before {
  ...
  background: -webkit-radial-gradient(
    center,
    ellipse,
    rgba(250, 230, 180, 1) 0,
    rgba(250, 230, 180, 1) 5%,
    rgba(252, 218, 166, 1) 6%,
    rgba(252, 218, 166, 1) 15%,
...
.sea .sun_set_sea {
  ...
  background: -webkit-gradient(
    ...
    color-stop(10%, rgba(255, 199, 147, 1)),
    color-stop(35%, rgba(255, 199, 147, 1)),
    color-stop(40%, rgba(250, 230, 180, 1)),
    color-stop(60%, rgba(250, 230, 180, 1)),
    color-stop(65%, rgba(255, 199, 147, 1)),
    color-stop(90%, rgba(255, 199, 147, 1)),
    to(rgba(255, 255, 255, 0))
  );
  background: -webkit-linear-gradient(
    left,
    rgba(255, 255, 255, 0) 0,
    rgba(255, 199, 147, 1) 10%,
    rgba(255, 199, 147, 1) 35%,
    rgba(250, 230, 180, 1) 40%,
    rgba(250, 230, 180, 1) 60%,
    rgba(255, 199, 147, 1) 65%,
    rgba(255, 199, 147, 1) 90%,
    rgba(255, 255, 255, 0) 100%
  );
...
.sky div:nth-child(3):after {
  opacity: 0;
  -webkit-box-shadow: 1538px 558px 0 #fff, 1845px 202px 0 #fff,
    637px 609px 0 #fff, 1156px 697px 0 #fff, 1873px 391px 0 #fff,
    963px 487px 0 #fff, 1987px 696px 0 #fff, 1296px 65px 0 #fff,
    803px 622px 0 #fff, 315px 412px 0 #fff, 1280px 577px 0 #fff,
    1632px 273px 0 #fff, 768px 369px 0 #fff, 1051px 237px 0 #fff,
    13px 583px 0 #fff, 1259px 515px 0 #fff, 50px 544px 0 #fff,
    1292px 386px 0 #fff, 1095px 241px 0 #fff, 1804px 156px 0 #fff,
    1839px 339px 0 #fff, 954px 268px 0 #fff, 953px 639px 0 #fff,
    1600px 87px 0 #fff, 1426px 615px 0 #fff, 1405px 671px 0 #fff,
    694px 247px 0 #fff, 1760px 363px 0 #fff, 1715px 512px 0 #fff,
    1128px 284px 0 #fff, 282px 605px 0 #fff, 1280px 135px 0 #fff,
    1491px 116px 0 #fff, 1020px 200px 0 #fff, 1020px 205px 0 #fff,
    1554px 288px 0 #fff, 1591px 300px 0 #fff, 682px 177px 0 #fff,
    758px 190px 0 #fff, 300px 98px 0 #fff, 196px 64px 0 #fff, 889px 597px 0 #fff,
    741px 312px 0 #fff, 353px 227px 0 #fff, 1460px 159px 0 #fff,
    183px 519px 0 #fff, 1869px 610px 0 #fff, 74px 512px 0 #fff,
    35px 476px 0 #fff, 1945px 383px 0 #fff;
  box-shadow: 1538px 558px 0 #fff, 1845px 202px 0 #fff, 637px 609px 0 #fff,
    1156px 697px 0 #fff, 1873px 391px 0 #fff, 963px 487px 0 #fff,
    1987px 696px 0 #fff, 1296px 65px 0 #fff, 803px 622px 0 #fff,
    315px 412px 0 #fff, 1280px 577px 0 #fff, 1632px 273px 0 #fff,
    768px 369px 0 #fff, 1051px 237px 0 #fff, 13px 583px 0 #fff,
    1259px 515px 0 #fff, 50px 544px 0 #fff, 1292px 386px 0 #fff,
    1095px 241px 0 #fff, 1804px 156px 0 #fff, 1839px 339px 0 #fff,
    954px 268px 0 #fff, 953px 639px 0 #fff, 1600px 87px 0 #fff,
    1426px 615px 0 #fff, 1405px 671px 0 #fff, 694px 247px 0 #fff,
    1760px 363px 0 #fff, 1715px 512px 0 #fff, 1128px 284px 0 #fff,
    282px 605px 0 #fff, 1280px 135px 0 #fff, 1491px 116px 0 #fff,
    1020px 200px 0 #fff, 1020px 205px 0 #fff, 1554px 288px 0 #fff,
    1591px 300px 0 #fff, 682px 177px 0 #fff, 758px 190px 0 #fff,
    300px 98px 0 #fff, 196px 64px 0 #fff, 889px 597px 0 #fff, 741px 312px 0 #fff,
    353px 227px 0 #fff, 1460px 159px 0 #fff, 183px 519px 0 #fff,
    1869px 610px 0 #fff, 74px 512px 0 #fff, 35px 476px 0 #fff,
    1945px 383px 0 #fff;
}
...
.sky div:nth-child(2):before {
  background: -webkit-gradient(
    ...
    left bottom,
    from(rgba(255, 255, 255, 0)),
    to(rgba(255, 199, 147, 1))
  );
  background: -webkit-linear-gradient(
    top,
    rgba(255, 255, 255, 0) 0,
    rgba(255, 199, 147, 1) 100%
  );
  background: -o-linear-gradient(
    top,
    rgba(255, 255, 255, 0) 0,
...
.sea div:nth-child(10) {
  top: 142px;
  left: 481px;
  -webkit-animation: wave 3.1s ease 0.5s infinite;
  animation: wave 3.1s ease 0.5s infinite;
}
...
.ship div:nth-child(2) {
  ...
  border: 0 solid rgba(0, 0, 0, 0);
  border-radius: 1px 1px 0 0/1px 0 0 0;
  -webkit-box-shadow: 70px 0 0 rgba(255, 255, 255, 0.5),
    60px 0 0 rgba(255, 255, 255, 0.5), 20px 0 0 rgba(255, 255, 255, 0.5),
    30px 0 0 rgba(255, 255, 255, 0.5), 40px 0 0 rgba(255, 255, 255, 0.5),
    50px 0 0 rgba(255, 255, 255, 0.5);
  box-shadow: 70px 0 0 rgba(255, 255, 255, 0.5),
    60px 0 0 rgba(255, 255, 255, 0.5), 20px 0 0 rgba(255, 255, 255, 0.5),
    30px 0 0 rgba(255, 255, 255, 0.5), 40px 0 0 rgba(255, 255, 255, 0.5),
    50px 0 0 rgba(255, 255, 255, 0.5);
}
...
.mountain2 div:before {
  ...
  left: -210px;
  top: 0;
  border-radius: 0 0 0 400px / 0 0 0 60px;
}
...
.bird3 {
  width: 20px;
  height: 10px;
  border-radius: 0 10px 15px 20px/0px 0 10px 10px;
  background: #363636;
  bottom: 35%;
  left: 20%;
...
.bird3:before {
  ...
  top: 0;
  right: -6px;
  border-radius: 0 15px 20px 0/ 0 10px 9px 0;
  background: #363636;
}
...
.tree {
  ...
  -webkit-box-shadow: -135px 2px 0 #789, -90px -10px 0 #789, -20px -10px 0 #789,
    20px -5px 0 #789, 35px 0 0 #789, 90px -5px 0 #789, 135px 13px 0 #789,
    200px 20px 0 #789;
  box-shadow: -135px 2px 0 #789, -90px -10px 0 #789, -20px -10px 0 #789,
    20px -5px 0 #789, 35px 0 0 #789, 90px -5px 0 #789, 135px 13px 0 #789,
    200px 20px 0 #789;
}
...
.tree:before {
  ...
  -webkit-box-shadow: -75px 10px 0 #665, -50px 10px 0 #665, 20px -5px 0 #665,
    35px 0 0 #665, 90px -5px 0 #665, 135px -10px 0 #665, 200px -10px 0 #665;
  box-shadow: -75px 10px 0 #665, -50px 10px 0 #665, 20px -5px 0 #665,
    35px 0 0 #665, 90px -5px 0 #665, 135px -10px 0 #665, 200px -10px 0 #665;
}
...
.tree:after {
  ...
  -ms-transform: rotate(5deg);
  transform: rotate(5deg);
  -webkit-box-shadow: -105px 5px 0 #998, -50px 0 0 #998, 35px -5px 0 #998,
    20px 0 0 #998, 90px 2px 0 #998, 135px 10px 0 #998, 200px -5px 0 #998;
  box-shadow: -105px 5px 0 #998, -50px 0 0 #998, 35px -5px 0 #998, 20px 0 0 #998,
    90px 2px 0 #998, 135px 10px 0 #998, 200px -5px 0 #998;
}
...
.sky div:nth-child(1):after {
  -webkit-animation: mov_stars 3s linear 0.5s infinite;
  animation: mov_stars 3s linear 0.5s infinite;
}
